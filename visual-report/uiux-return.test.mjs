  ...
  test(`${name}: drawer and reader settings return to their source, and changed forms require a decision`, async t => {
    ...
    async function scenario(label, run) {
      await t.test(label, async subtest => {
        ...
        subtest.after(() => page.context().close());
        ...
        await run(page, drive);
      });
    }
    await scenario("drawer-return-and-member-filter", async (page, drive) => {
    ...
    await scenario("changed-form-decisions", async (page, drive) => {
    ...
    await scenario("reader-preferences-return", async (page, drive) => {
