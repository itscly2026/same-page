...
export const extraVisualReportScenarios = [
  ...
  reader("reader-layer-save-failure", "阅读器 · 显示设置保存失败", "故意注入 503，保留原值并显示恢复动作。", selector(".reader-layer-feedback"), [showControls, click("button", "看哪些批注"), click("checkbox", "显示 E · Ensemble")]),
