...
export const extraVisualReportScenarios = [
  ...
  reader("reader-offline-failure", "阅读器 · 离线下载失败", "固定版本下载故意注入 503，提供重试且不宣称可离线。", role("button", "重试下载离线副本"), [showControls, click("button", "更多"), { type: "armFailures" }, click("button", "下载离线副本")]),
