...
it("opens diagnostics from the footer without losing the current session's records", async () => {
  render(
    <MemoryRouter>
      <Routes>
  ...
  fireEvent.click(within(screen.getByRole("contentinfo")).getByRole("link", { name: "故障诊断" }));
