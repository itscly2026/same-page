    ...
    <div className="privacy-page">
      ...
      <main className="privacy-document" aria-labelledby="privacy-title">
        ...
        <section aria-labelledby="privacy-use">
          ...
          <p>
            我们不出售你的个人信息，不使用这些信息投放定向广告，也不会把个人层批注提供给云盘管理员或其他成员。
          </p>
        </section>
        ...
        <section aria-labelledby="privacy-sharing">
          ...
          <p>
            个人层只对你本人开放。共享层和乐谱属于对应云盘，具有访问权的成员或访客可以查看；获得相应编辑权的成员可以修改。共享批注可能保留创建者或最后修改者的云盘内显示名。只有云盘管理员可以查看成员名单和成员的登录邮箱。
          </p>
          <p>
        ...
        <section aria-labelledby="privacy-retention">
          ...
          <ul>
            ...
            <li>
              成员退出、移除及其个人层恢复与自动清理流程仍在开发。普通云盘的设计目标是立即撤销云端访问、个人层保留 30 天后删除；目前不能将其理解为已自动执行。公开体验的登录访问独立于成员关系，其个人层不因成员移除进入这段保留期。
            </li>
            <li>
              用户删除与恢复的自助流程仍在开发。当前如需删除，请通过下方邮箱联系我们确认处理范围与安排。设计目标是立即停止登录，身份数据和个人层保留 30 天后删除，共享批注仅保留最终云盘内显示名；这不是已上线的自动处理承诺。
            </li>
            <li>
              移入回收站的乐谱和被替换的旧 PDF 版本最多保留 30 天，之后按服务规则删除。
            </li>
          </ul>
          <p>
            已下载到设备的内容无法远程收回。明确退出登录时，Same Page 会清除当前浏览器中的个人层、可编辑状态和用户偏好；已同步并去除个人身份的共享内容可能继续保留以供离线查看。你也可以通过浏览器或操作系统清除站点数据。
          </p>
        </section>
