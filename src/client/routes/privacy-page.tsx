      ...
      <main className="privacy-document" aria-labelledby="privacy-title">
        ...
        <section aria-labelledby="privacy-retention">
          ...
          <ul>
            ...
            <li>
              普通云盘的成员退出或被移除后，该成员关系授予的云端访问与同步立即撤销，个人层保留 30 天，期间可由现任管理员恢复。管理员不能读取个人层。公开体验中，本人个人层的访问与保留不依赖成员关系。
            </li>
            <li>
              你可以在“用户设置”完成管理员交接、重新验证原登录方式并确认删除。删除会立即撤销产品会话与云端访问；身份数据和个人层进入 30 天恢复期。期间使用删除时的登录方式验证后，只能明确确认恢复，不能直接访问云盘。恢复期结束后定时任务清理身份与个人层。共享批注继续保留最终云盘内显示名，不以登录邮箱或全局资料名作为署名。
            </li>
            <li>
