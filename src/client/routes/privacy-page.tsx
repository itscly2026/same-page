    ...
    <div className="privacy-page">
      ...
      <main className="privacy-document" aria-labelledby="privacy-title">
        ...
        <section aria-labelledby="privacy-sharing">
          ...
          <p>
            个人层默认仅自己可见。共享层和乐谱属于对应云盘，具有访问权的成员或访客可以查看；获得相应编辑权的成员可以修改。共享批注可能保留创建者或最后修改者的云盘内显示名。只有云盘管理员可以查看成员名单和成员的登录邮箱。
          </p>
          <p>
        ...
        <section aria-labelledby="privacy-retention">
          ...
          <ul>
            ...
            <li>
              普通云盘的成员退出或被移除后，该成员关系授予的云端访问与同步立即撤销，个人层保留 30 天，期间可由现任管理员恢复。个人层默认仅自己可见。公开体验中，本人个人层的访问与保留不依赖成员关系。
            </li>
            <li>
