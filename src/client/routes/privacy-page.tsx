      ...
      <main className="privacy-document" aria-label="隐私政策">
        ...
        <section aria-labelledby="privacy-collect">
          ...
          <ul>
            ...
            <li>
              <strong>云盘内容：</strong>
              你所在的云盘、云盘内显示名和权限，上传的 PDF 乐谱及文件名，以及个人层和共享层中的笔记、偏好与同步状态。
            </li>
            <li>
              <strong>设备本地数据：</strong>
              为支持离线使用，浏览器可能在当前设备保存乐谱、笔记、偏好和待同步操作。访客访问记录和离线副本也可能保存在当前设备。
            </li>
          </ul>
        </section>
        ...
        <section aria-labelledby="privacy-use">
          ...
          <p>
            我们不出售你的个人信息，不使用这些信息投放定向广告。个人层笔记默认仅自己可见。
          </p>
        </section>
        ...
        <section aria-labelledby="privacy-sharing">
          ...
          <p>
            个人层默认仅自己可见。共享层和乐谱属于对应云盘，具有访问权的成员或访客可以查看；获得相应编辑权的成员可以修改。共享笔记可能保留创建者或最后修改者的云盘内显示名。成员名单只向云盘拥有者、受托权限管理者及有成员移除权限的成员开放，具体信息以其授权范围为准。
          </p>
          <p>
        ...
        <section aria-labelledby="privacy-diagnostics">
          ...
          <p>主动发送的诊断包含错误编号、时间、次数、版本、操作类别、阶段及可重试性，以及浏览器与系统版本、窗口尺寸、网络提示、PWA 状态；从阅读器发送时还包含谱面显示方式、阅读或编辑状态、待同步与冲突数量。系统不会自动收集乐谱或笔记正文、截图、文件名、邮箱、原始 IP、凭据、完整网址或原始异常。你填写的问题描述会随报告发送，请勿包含私人内容、密码、验证码或邀请码。</p>
