...
describe("highlighter deposition", () => {
  it.each(["round","chisel"] as const)("darkens a retraced %s stroke without seams or sample-rate darkening", nib => {
