...
export function InstallProvider({ children }: { children: ReactNode }) {
  ...
  const install = async () => {
    ...
    try {
      ...
      if (result.outcome === "accepted") { setRequested(true); setOpen(false); dismiss(); }
  ...
  return <InstallContext value={{ hidden: installed, requested, nativeAvailable: Boolean(prompt) && !external, suggest: !installed && !dismissed, open: show, dismiss }}>
    {children}
